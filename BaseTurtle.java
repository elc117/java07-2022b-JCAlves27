 ...
 * leaving a trail as it goes. The turtle has a pen that can be raised and
 * lowered;
 ...
 * triangle pointing in the direction that the turtle is facing. Any change to
 * the
 ...
 * extends from -10 at the left * to 10 at the right and from -10 at the bottom
 * to 10 at the top.
 ...
 * The original code was refactored to improve object orientation / separation
 * of concerns.
 */
...
public class BaseTurtle {
    ...
    /**
     * Poor BaseTurtle... It draws nothing, but its children will do amazing
     * drawings
     */
    public void draw() {
